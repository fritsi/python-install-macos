class SqliteFritsiWithOpenssl3 < Formula
  ...
  depends_on "tcl-tk-fritsi-with-openssl3"
  depends_on "zlib"

  def install
    %w[ncurses-fritsi readline-fritsi tcl-tk-fritsi-with-openssl3 zlib].each do |name|
    ...
    args = [
      ...
      "--enable-tcl",
      "--enable-threadsafe",
      "--with-tcl=#{Formula["tcl-tk-fritsi-with-openssl3"].opt_lib}",
