class SqliteFritsiModWithOpenssl3 < Formula
  ...
  depends_on "tcl-tk-fritsi-mod-with-openssl3"
  depends_on "zlib"

  def install
    %w[ncurses-fritsi-mod readline-fritsi-mod tcl-tk-fritsi-mod-with-openssl3 zlib].each do |name|
    ...
    args = [
      ...
      "--enable-tcl",
      "--enable-threadsafe",
      "--with-tcl=#{Formula["tcl-tk-fritsi-mod-with-openssl3"].opt_lib}",
